...
//  05/21/97    CAR changed initializeApp to set the document base URL to a valid URL
//  05/15/97    CAR Added special handling to setDocumentBase when running inside of Netscape
//                  for Windows off of a local drive.
